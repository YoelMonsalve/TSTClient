...
def run_app(host, working_dir = "", verbose = False):
	...
	run_ssh_command(ssh_client, f'echo "Running app over folder {working_dir}" ... && echo')
	run_ssh_command(ssh_client, f'source ~/.scripts/run work/{working_dir}')
	"""
...
def test():
	...
	#decompress_files(ssh_client, 'work/2019_TPL/21S/csv')
