...
#p = subprocess.Popen(["sftp", "54.38.79.195"], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
...
p = subprocess.Popen(["sftp", "-i", ".ssh/id_rsa", 
	"-b", "scripts/transfer.sftp", "tst@54.38.79.195"], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
if p is not None:
